...
//    @Value("${imp.rest-api.secret-key}")
    ...
    public String portOneGetToken() {
        ...
        System.out.println("===================================");
        System.out.println(tokenDTO.getHeaders());
        System.out.println(tokenDTO.getBody().getResponse().getAccessToken());
        System.out.println("===================================");
        //---------------------------------------------- 여기까지 토큰을 받기 위함

        return tokenDTO.getBody().getResponse().getAccessToken();
    }
