...
// ---------------------------------------------------------------------------------
    ...
    public List<Invitation> myInvitationPagingLists(Integer page){
        ...
        List<Invitation> pagingLists = this.invitationRepository.findByInvitationPagingLists(pagingParams);

        return pagingLists;
    }

    // 페이징 계산
    public InvitationPagingResponseDTO pagingParam(Integer page) {
        // 전체 글 갯수 조회
        int pageCount = this.invitationRepository.pageCount();
