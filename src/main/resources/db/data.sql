...
insert into theater_tb(theater_name, tel, address, park, total_seat) values ('메가박스 대구 만촌동 지점', '054-422-2005', '대구시 수성구 만촌동 1005-1', '주차장 넓음', 140);
...
insert into movie_tb(movie_name, synopsis,thumbnail, directing_instension, genre, running_grade, director, actor, director_careers, director_awards_film, online_awards_film, online_release_date, online_end_date, offline_release_date, offline_end_date)
