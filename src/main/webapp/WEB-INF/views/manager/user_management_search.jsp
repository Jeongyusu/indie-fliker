...
<%--                    </c:choose>--%>
            ...
            <div class="p_paging p_usermanagement_bottom">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <a class="p_priveous" href="/admin/user-management?page=${paging.page-1}&keyword=${param.keyword}">이전</a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <a class="page_number" href="/admin/user-management?page=${i}&keyword=${param.keyword}" style="color: #7f7f7f">${i}</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <a class="p_next" href="/admin/user-management?page=${paging.page+1}&keyword=${param.keyword}">다음</a>
                    </c:otherwise>
                </c:choose>
            </div>
