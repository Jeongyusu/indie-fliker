...
<div class="p_flex_center">
    <div class="p_main">
        ...
        <div class="p_grade_update_container2">
            ...
            <div class="p_paging p_grade_update_bottom">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <a class="p_priveous" href="/admin/grade-update?page=${paging.page-1}&keyword=${param.keyword}" style="color: #7f7f7f">이전</a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <a class="page_number" href="/admin/grade-update?page=${i}&keyword=${param.keyword}">${i}</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <a class="p_next" href="/admin/grade-update?page=${paging.page+1}&keyword=${param.keyword}">다음</a>
                    </c:otherwise>
                </c:choose>
            </div>
