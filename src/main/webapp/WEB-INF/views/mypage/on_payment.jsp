...
<div class="container">
    ...
    <c:forEach var="MyOnlinePaymentDTO" items="${myOnlinePaymentLists}" varStatus="status">
        <div class="l_movie_card card text-bg-light">
            <div class="row g-0">
                <div class="col-md-4 d-flex align-items-center justify-content-center l_card_container">
                    <img src="${MyOnlinePaymentDTO.thumbnail}" class="l_fund_card_img" alt="">
                </div>
                ...
                <div class="col-md-3 d-flex flex-column align-items-end justify-content-end mb-4">
                  	<form action="/reservation/${MyOnlinePaymentDTO.movieId}/on-ticket">
                        <input type="hidden" value="${MyOnlinePaymentDTO.reservationId}" id="reservationId${status.count}">
                    ...
                    <input type="hidden" value="${MyOnlinePaymentDTO.orderId}" id="orderId${status.count}">
                    <input type="hidden" value="${MyOnlinePaymentDTO.paymentId}" id="paymentId${status.count}">
                    <input type="hidden" value="${MyOnlinePaymentDTO.movieId}" id="movieId${status.count}">
