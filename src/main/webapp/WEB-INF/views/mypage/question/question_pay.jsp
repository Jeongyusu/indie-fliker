...
<div class="container l_main_margin_bottom">
    ...
    <div class="k_ask_s_container">
        ...
        <div>
            <c:forEach var="questionResponseDTO" items="${questionPayPagingLists}" varStatus="status">
            ...
            <div class="p_paging p_question_pay_paging">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <a class="p_priveous" href="/question/pay?page=${paging.page-1}">이전</a>
                    </c:otherwise>
                </c:choose>
                ...
                <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <a class="page_number" href="/question/pay?page=${i}" style="color: #7f7f7f">${i}</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <a class="p_next" href="/question/pay?page=${paging.page+1}">다음</a>
                    </c:otherwise>
                </c:choose>
            </div>
