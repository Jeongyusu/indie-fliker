...
<body class="l_body">
  ...
  <div class="row mt-5 justify-content-center text-center">
    <u><div class="h4 mb-5">박스오피스</a></div></u>
    ...
    <div class="col" style="max-width: 300px;">
      <div class="card l_main_card" style="border: none;">
          <img src="https://img.megabox.co.kr/SharedImg/2023/10/25/FXFCIlhJ6JEcTfk8BpVkSWvmf84sSpe9_420.jpg" class="card-img" alt="...">
          <div class="card-img-overlay text-white">
            <h3>2</h3>
          </div>
          <div class="l_overlay_button">
    ...
    <div class="col" style="max-width: 300px;">
      <div class="card l_main_card" style="border: none;">
          <img src="https://img.megabox.co.kr/SharedImg/2023/11/15/OM0860oG9r27Dz8NvMXxZJqydpkEwMdK_420.jpg" class="card-img" alt="...">
          <div class="card-img-overlay text-white">
            <h3>3</h3>
          </div>
          <div class="l_overlay_button">
    ...
    <div class="col" style="max-width: 300px;">
      <div class="card l_main_card" style="border: none;">
          <img src="https://img.megabox.co.kr/SharedImg/2023/11/01/bgAwV6TVs8nZAlfFdCiPsJySiHlp0vRC_420.jpg" class="card-img" alt="...">
          <div class="card-img-overlay text-white">
            <h3>4</h3>
          </div>
          <div class="l_overlay_button">
  ...
  <div class="row">
    <div class="col">
      <div class="card l_main_hovcard bg-dark text-white">
        <img src="https://dummyimage.com/800x550/000/fff.jpg" class="card-img" alt="Blade Runner">
      </div>
    </div>
    <div class="col">
      <div class="card l_main_hovcard bg-dark text-white">
