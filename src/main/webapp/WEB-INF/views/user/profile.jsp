...
<div class="k_profile_main">
    ...
    <div class="k_profile_first_container">
        <div>닉네임</div>
        <input type="text" class="k_profile_nicknmae" placeholder="${nicknmae}">
        <div class="k_profile_tel_div">전화번호</div>
        <input type="tel" class="k_profile_tel_input" placeholder="${tel}">
    </div>
    <div>
        <div class="k_profile_password_div">비밀번호</div>
        <input type="password" placeholder="비밀번호 입력" class="k_profile_tel_input">
        <div class="k_profile_password_div">
            <input type="password" placeholder="비밀번호 확인" class="k_profile_tel_input">
        </div>
    </div>
    <div class="k_profile_bttns_margin">
        <button class="k_profile_bttn_cancle">취소</button>
        <button class="k_profile_bttn_ok">확인</button>
    </div>
