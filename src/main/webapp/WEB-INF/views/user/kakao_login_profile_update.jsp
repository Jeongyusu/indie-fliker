...
<div class="k_profile_main">
    ...
    <form id="form" action="/user/kakao-login-profile-update" method="post" enctype="multipart/form-data">
        ...
        <div class="k_form_group">
            ...
            <input type="text" class="form-control k_join_radius" placeholder="닉네임 입력" id="username" name="username" >
            <p id="usernameCkeck"></p>
        </div>
        <div class="k_form_group">
            <label class="k_input_label">전화번호</label>
            <input type="text" class="form-control k_join_radius k_profile_input" placeholder="전화번호를 입력해주세요. (- 생략)" id="tel" name="tel">
            <p id="telCkeck"></p>
        </div>
        <div class="k_form_group">
